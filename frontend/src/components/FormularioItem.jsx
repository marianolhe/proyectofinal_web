...
function Formulario({ onAgregarViaje, viajeEditando, onActualizarViaje, inputNombreRef }) {
    ...
    // pre-llena el formulario cuando se va a editar un viaje
    useEffect(() => {
        if (viajeEditando) {
            setFormulario({
    ...
    return (
        <div className="formulario-container">
            <form onSubmit={enviarFormulario}>
                <h1>{viajeEditando ? 'Editar Viaje' : 'Agregar Viaje'}</h1>

                <div className="formulario-grid">

                    <div className="campo">
                        <label>Nombre del viaje</label>
                        {/* ref para auto-focus con Ctrl+N */}
                        <input
                            type="text"
                    ...
                    <div className="campo">
                        ...
                        <input
                            type="number"
                            placeholder="Puntuación del 0-10"
                    ...
                    <button className="btn-guardar" type="submit">
                        {viajeEditando ? 'Actualizar' : 'Guardar'}
                    </button>
